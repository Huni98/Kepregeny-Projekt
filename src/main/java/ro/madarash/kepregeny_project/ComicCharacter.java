...
public abstract class ComicCharacter {
    ...
    /**
     * Creates a two-way (reciprocal) affiliation between two characters. For
     * example, if A is an "Ally" to B, B becomes an "Ally" to A.
     */
    ...
    public List<ComicBook> getComicBookAppearances() {
        return comicBookAppearances;
    }

    public Map<ComicCharacter, String> getCharacterAffiliations() {
        return characterAffiliations;
    }
    ...
    public void setOrigin(String originStory) {
        this.originStory = originStory;
    }

    
    public void clearAppearances() {
        this.comicBookAppearances.clear();
    }

    public void clearCreatorWriters() {
        this.creatorWriters.clear();
    }

    public void clearCreatorArtists() {
        this.creatorArtists.clear();
    }

    public void clearCharacterAffiliations() {
        this.characterAffiliations.clear();
    }
}
